...
internal object PairDetailTestTags {
    ...
    const val MoistureValue = "pair_detail_moisture_value"
    const val SensorValue = "pair_detail_sensor_value"
    const val ManualStartButton = "pair_detail_manual_start_button"
    const val MoistureTestButton = "pair_detail_moisture_test_button"
