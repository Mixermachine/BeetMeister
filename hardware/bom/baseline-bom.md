...
| 8-channel relay board | 1 | Active-low input behavior assumed by the spec |
...
- Verify the selected relay board reliably recognizes 3.3 V logic low as the active state and stays off at the inactive high level down to 3.1 V supply conditions.
